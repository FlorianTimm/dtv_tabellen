...
/**
 * Programm zum Umwandeln von DTV-Tabellen für BWVI
...
public class DTVTabelle extends JFrame implements ActionListener {
    ...
    /*
     * Wird ausgelöst, wenn Button oder Menü-Punkt geklickt wird
     * 
     * @see
    ...
    /**
     * Lädt die Daten aus der ArrayList dateien und stellt diese in der Tabelle
     * da z.B. nach dem Laden oder Umsortieren von Dateien
     */
